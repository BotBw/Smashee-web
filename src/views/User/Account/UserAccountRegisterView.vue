            ...
            <div class="col-3">
                <form @submit.prevent="register">
                    ...
                    <div class="mb-3">
                        ...
                        <input v-model="confirmedPassword" type="password" class="form-control" id="confirmedPassword" placeholder="Please confirm your password">
                    </div>
...
export default {
    ...
    setup() {
        ...
        const register = () => {
            $.ajax({
                url: "http://121.41.170.64:3000/api/user/account/register/",
                type: "post",
                data: {
